...
import net.yanes.pixelmonkits.procedures.CheckStatusProcedureProcedure;
...
public class CheckStatusCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("checkstatus")
