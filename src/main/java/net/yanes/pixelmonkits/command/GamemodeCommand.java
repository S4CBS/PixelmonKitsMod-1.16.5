...
import net.yanes.pixelmonkits.procedures.NoWorkProcedure;
...
public class GamemodeCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("gamemode")
				...
				.then(Commands.literal("creative").executes(arguments -> {
					...
					NoWorkProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
