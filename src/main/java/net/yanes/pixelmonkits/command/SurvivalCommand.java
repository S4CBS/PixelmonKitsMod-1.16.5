...
import net.yanes.pixelmonkits.procedures.SurvivalProcedureProcedure;
...
public class SurvivalCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("survival")
				...
				.executes(arguments -> {
					...
					SurvivalProcedureProcedure.executeProcedure(
