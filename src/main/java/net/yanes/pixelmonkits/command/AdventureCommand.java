...
import net.yanes.pixelmonkits.procedures.AdventureProcedureProcedure;
...
public class AdventureCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("adventure")
				...
				.executes(arguments -> {
					...
					AdventureProcedureProcedure.executeProcedure(
